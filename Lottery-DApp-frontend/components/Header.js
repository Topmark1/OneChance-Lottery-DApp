...
function Header() {
  ...
  return (
    <div className=""  id="home">
      <nav className="w-full bg-[#007db3] shadow ">
    <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-6 lg:px-14">
      <div>
        <div className="flex items-center justify-between py-3 md:py-5 md:block ">
        <Link href="/">
            <div className="flex items-center">
            <span className='w-14 sm:w-20 mr-2'><img className='' src="./images/onechance logo.png" /></span>
             {/* <h2 className="font-AK text-[37px] text-white" >OneChance</h2> */}
             </div>
          </Link>
      ...
      <div>
        ...
        >
          <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0 text-[16px] font-bold">
            ...
            <li className="text-[#007db3]">
              <Link href="/newpage">
               <button className="px-5 py-2.5 rounded hover:bg-[#AAC4E6] hover:shadow-2xl bg-white">Contact Us</button> 
              </Link>
            </li>
          </ul>
        </div>
